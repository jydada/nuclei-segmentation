...
################
        ...
        gt_name = os.path.join(filepath2,allDir2)
        evalpic = Image.open(eval_name)
...
segpath='E:\\VI-VIII_nuclei-segmentation\\seg\\'
gtpath='E:\\VI-VIII_nuclei-segmentation\\data\\val\\masks\\'
savepath='E:\\VI-VIII_nuclei-segmentation\\seg_valuation\\'
